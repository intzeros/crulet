...
void Rule_4_4_1_3::registerMatchers(MatchFinder *Finder) {
  StatementMatcher Matcher = implicitCastExpr().bind("implicitCastExpr");
  Finder->addMatcher(Matcher, this);
}

void Rule_4_4_1_3::run(const MatchFinder::MatchResult &Result) {
