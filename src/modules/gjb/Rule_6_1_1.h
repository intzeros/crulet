#ifndef CRULET_GJB_RULE_6_1_1_H
#define CRULET_GJB_RULE_6_1_1_H
...
class Rule_6_1_1 : public CruletChecker {
public:
  Rule_6_1_1(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg)
