#ifndef CRULET_GJB_RULE_7_1_3_H
#define CRULET_GJB_RULE_7_1_3_H
...
class Rule_7_1_3 : public CruletChecker {
public:
  Rule_7_1_3(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
