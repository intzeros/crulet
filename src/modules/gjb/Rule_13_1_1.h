#ifndef CRULET_GJB_RULE_13_1_1_H
#define CRULET_GJB_RULE_13_1_1_H
...
class Rule_13_1_1 : public CruletChecker {
public:
  Rule_13_1_1(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg)
