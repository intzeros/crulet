#ifndef CRULET_GJB_RULE_1_2_1_H
#define CRULET_GJB_RULE_1_2_1_H
...
class Rule_1_2_1: public CruletChecker {
public:
    Rule_1_2_1(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg):
