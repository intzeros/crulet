#ifndef CRULET_GJB_RULE_13_1_4_H
#define CRULET_GJB_RULE_13_1_4_H
...
class Rule_13_1_4 : public CruletChecker {
public:
  Rule_13_1_4(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
