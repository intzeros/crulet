#ifndef CRULET_GJB_RULE_7_1_2_H
#define CRULET_GJB_RULE_7_1_2_H
...
class Rule_7_1_2 : public CruletChecker {
public:
  Rule_7_1_2(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
