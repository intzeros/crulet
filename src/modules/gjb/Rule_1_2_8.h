#ifndef CRULET_GJB_RULE_1_2_8_H
#define CRULET_GJB_RULE_1_2_8_H
...
class Rule_1_2_8: public CruletChecker {
public:
    Rule_1_2_8(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg):
