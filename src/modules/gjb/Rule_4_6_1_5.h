#ifndef CRULET_GJB_RULE_4_6_1_5_H
#define CRULET_GJB_RULE_4_6_1_5_H
...
class Rule_4_6_1_5 : public CruletChecker {
public:
  Rule_4_6_1_5(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg)
