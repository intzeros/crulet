#ifndef CRULET_GJB_RULE_1_2_2_H
#define CRULET_GJB_RULE_1_2_2_H
...
class Rule_1_2_2: public CruletChecker {
public:
    Rule_1_2_2(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg):
