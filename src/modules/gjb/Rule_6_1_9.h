#ifndef CRULET_GJB_RULE_6_1_9_H
#define CRULET_GJB_RULE_6_1_9_H
...
class Rule_6_1_9 : public CruletChecker {
public:
  Rule_6_1_9(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
