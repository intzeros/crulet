#ifndef CRULET_GJB_RULE_3_1_5_H
#define CRULET_GJB_RULE_3_1_5_H
...
class Rule_3_1_5 : public CruletChecker {
public:
  Rule_3_1_5(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
