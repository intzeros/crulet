#ifndef CRULET_GJB_RULE_3_1_8_H
#define CRULET_GJB_RULE_3_1_8_H
...
class Rule_3_1_8 : public CruletChecker {
public:
  Rule_3_1_8(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
