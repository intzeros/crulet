#ifndef CRULET_GJB_RULE_6_1_7_H
#define CRULET_GJB_RULE_6_1_7_H
...
class Rule_6_1_7 : public CruletChecker {
public:
  Rule_6_1_7(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
