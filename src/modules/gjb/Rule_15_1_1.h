#ifndef CRULET_GJB_RULE_15_1_1_H
#define CRULET_GJB_RULE_15_1_1_H
...
class Rule_15_1_1 : public CruletChecker {
public:
  Rule_15_1_1(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
