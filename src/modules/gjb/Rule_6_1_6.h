#ifndef CRULET_GJB_RULE_6_1_6_H
#define CRULET_GJB_RULE_6_1_6_H
...
class Rule_6_1_6 : public CruletChecker {
public:
  Rule_6_1_6(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg)
