#ifndef CRULET_GJB_RULE_1_1_5_H
#define CRULET_GJB_RULE_1_1_5_H
...
class Rule_1_1_5 : public CruletChecker {
public:
  Rule_1_1_5(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
