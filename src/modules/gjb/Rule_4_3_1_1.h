#ifndef CRULET_GJB_RULE_4_3_1_1_H
#define CRULET_GJB_RULE_4_3_1_1_H
...
class Rule_4_3_1_1 : public CruletChecker {
public:
  Rule_4_3_1_1(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg)
