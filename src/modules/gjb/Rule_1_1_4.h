#ifndef CRULET_GJB_RULE_1_1_4_H
#define CRULET_GJB_RULE_1_1_4_H
...
class Rule_1_1_4 : public CruletChecker {
public:
  Rule_1_1_4(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
