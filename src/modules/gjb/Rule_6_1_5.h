#ifndef CRULET_GJB_RULE_6_1_5_H
#define CRULET_GJB_RULE_6_1_5_H
...
class Rule_6_1_5 : public CruletChecker {
public:
  Rule_6_1_5(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
