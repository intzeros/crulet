#ifndef CRULET_GJB_RULE_6_1_2_H
#define CRULET_GJB_RULE_6_1_2_H
...
class Rule_6_1_2 : public CruletChecker {
public:
  Rule_6_1_2(CruletContext *Context, StringRef CheckerName, StringRef ReportMsg, 
